          ...
          <div className="lg:w-1/2 p-8 flex flex-col justify-center">
            <div className="mb-6">
              ...
              <div className="flex items-center mb-4">
                <span className="text-3xl font-semibold text-black">${typeof product.price === 'number' ? product.price.toFixed(2) : parseFloat(product.price || 0).toFixed(2)}</span>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <span className="ml-2 font-medium">${typeof product.price === 'number' ? product.price.toFixed(2) : parseFloat(product.price || 0).toFixed(2)}</span>
                </div>
                <div>
